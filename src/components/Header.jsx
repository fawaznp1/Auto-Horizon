...
const Navbar = () => {
  ...
  // Auto-close mobile menu on escape key
  useEffect(() => {
  ...
  const handleLinkClick = (e, href) => {
    // Prevent default for anchor links and handle smooth scrolling
    if (href.startsWith('#')) {
      e.preventDefault();
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white/95 backdrop-blur-md rounded-lg mt-2 shadow-xl border border-gray-200/20">
                ...
                {item.dropdown ? (
                  <div>
                    ...
                    <div 
                      ...
                      style={{
                        maxHeight: mobileDropdowns[index] ? `${item.dropdown.length * 60}px` : '0px'
                      }}
                    >
                      <div className="ml-4 space-y-1 bg-gray-50/50 rounded-lg p-2">
                        {item.dropdown.map((dropdownItem, dropdownIndex) => (
                          <a
                            ...
                            onClick={(e) => handleLinkClick(e, dropdownItem.href)}
                          >
                            <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-all duration-200 scale-0 group-hover:scale-100"></div>
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              >
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-[1.02] shadow-lg">
                  Join Us
                </button>
              </a>
            </div>
